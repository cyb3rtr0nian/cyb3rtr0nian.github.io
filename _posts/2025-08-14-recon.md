...
- Password Spraying: Use compromised credentials from Have I Been Pwned to test for password reuse across platforms, but only in authorized testing scenarios.